...
//      string?
var person = {name:"bond", age:35, secretAgen:true};
...
STUDENT ACTIVITY
	...
	2.  What are the possible answers for this: /[Jj]ava[Ss]cript/
		...
		Answer: javascript Javascript javaScript
...
*/
	...
	var clean = str.replace(/(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/g, "jc@gmail.com");
	console.log(clean);
